...
public enum ErrorCode {
    ...
    TEAM_NOT_FOUND_BY_SEMESTER(HttpStatus.BAD_REQUEST, "FOR002-400", "해당 연도, 학기에 해당하는 운영진이 없습니다."),
    TEAM_NOT_FOUND_BY_STUDENT_ID(HttpStatus.BAD_REQUEST, "FOR003-400", "해당 학번에 해당하는 운영진이 없습니다."),
